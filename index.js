...
const sessdata = config.SESSION_ID.replace("BEAMER-XMD~", '');
...
console.log("CONNECTING BEAMER-XMD🧬...");
...
console.log('BEAMER-XMD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ BEAMER-XMD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ Sang Lee ✅*
...
if(senderNumber.includes("254116266407")){
if(isReact) return
m.react("🎀")
   }
...
app.get("/", (req, res) => {
res.send("HEY, BEAMER-XMD STARTED ✅");
});
